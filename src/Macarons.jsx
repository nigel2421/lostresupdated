...
const Macarons = ({ macarons = [], isLoading = false, onSelectMacaron, onAddToCart }) => {
  if (isLoading || !macarons || macarons.length === 0) {
    return (
      <div className="macarons-container">
        <div className="macaron-category">
          <div className="boutique-flavors-grid" style={{ padding: 0 }}>
            <MacaronSkeletonGrid count={6} />
          </div>
        </div>
      </div>
    );
